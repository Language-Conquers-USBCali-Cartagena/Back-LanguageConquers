...
public class ManejadorCrearEstudianteTest {
    ...
    public static final String SE_CREO_EXITOSAMENETE_ESTUDIANTE = "Se creo exitosamente el estudiante.";
    public static final String ID_AVATAR_FALTANTE = "Debe ingresar un id avatar.";
    ...
    public static final String NICKNAME_ESTUDIANTE_LARGO = "Debe ingresar un nickname para el estudiante, no mayor a 80 caracteres.";
    ...
    public static final String MONEDAS_INICIALES_CERO = "Las monedas obtenidas al momento de crear el estudiante son 0.";
    ...
    public static final String USUARIO_CREADOR_FALTANTE = "Debe ingresar el usuario creador.";
    public static final String USUARIO_CREADOR_LARGO = "El nombre del usuario creador es muy largo, solo puede contener 50 caracteres.";
    public static final String FECHA_CREACION_FALTANTE = "Debe ingresar una fecha de creación.";
    ...
    public static final String USUARIO_CREADOR = "FKHFHJFKEFHEH FHKFHKHFK HFKDHSFKH FKHKHKH HFKHK HG ";
    @Autowired
    ...
    void deberiaCrearExistosamenteEstudiante() throws Exception {
        ...
        String crearEstudiante = estudianteService.crearEstudiante(estudiante);
        assertEquals(SE_CREO_EXITOSAMENETE_ESTUDIANTE, crearEstudiante);
    ...
    void deberiaFallarPorIdAvatarNull() throws Exception {
        ...
        assertEquals(exception.getMessage(), ID_AVATAR_FALTANTE);
    ...
    void deberiaFallarPorIdGeneroNull() throws Exception {
        ...
        assertEquals(exception.getMessage(), ID_GENERO_FALTANTE);
    ...
    void deberiaFallarPorIdSemestreNull() throws Exception {
        ...
        assertEquals(exception.getMessage(), ID_SEMESTRE_FALTANTE);
    ...
    void deberiaFallarPorIdProgramaNull() throws Exception {
        ...
        assertEquals(exception.getMessage(), ID_PROGRAMA_FALTANTE);
    ...
    void deberiaFallarPorIdEstadoNull() throws Exception {
        ...
        assertEquals(exception.getMessage(), ID_ESTADO_FALTANTE);
    ...
    void deberiaFallarPorIdProgramaNegativo() throws Exception {
        ...
        assertEquals(exception.getMessage(), DEBE_INGRESAR_ID_PROGRAMA_VALIDO);
    ...
    void deberiaFallarPorUsuarioCreadorNull() throws Exception {
        ...
        assertEquals(exception.getMessage(),USUARIO_CREADOR_FALTANTE);
    ...
    void deberiaFallarPorUsuarioCreadorLargo() throws Exception {
        ...
        assertEquals(exception.getMessage(),USUARIO_CREADOR_LARGO);
    ...
    void deberiaFallarPorFechaCreacionNull() throws Exception {
        ...
        assertEquals(exception.getMessage(),FECHA_CREACION_FALTANTE);

    }

    @Test
    @DisplayName("Deberia fallar Por correo existente profesor")
    void deberiaFallarPorCorreoExistenteProfesor() throws Exception {
        EstudianteDTO estudianteDTO = new EstudianteTestDataBuilder()
                .conCorreo("angelamaria731@hotmail.com")
                .build();
        Estudiante estudiante = estudianteMapper.toEntity(estudianteDTO);
        Mockito.when(avatarDAO.existsById(estudiante.getAvatar().getIdAvatar())).thenReturn(true);
        Mockito.when(generoDAO.existsById(estudiante.getGenero().getIdGenero())).thenReturn(true);
        ...
        Mockito.when(estudianteDAO.existsById(estudiante.getEstado().getIdEstado())).thenReturn(true);
        Mockito.when(programaDAO.existsById(estudiante.getPrograma().getIdPrograma())).thenReturn(true);
        Mockito.when(profesorDAO.existsByCorreo(estudiante.getCorreo())).thenReturn(true);
        Mockito.when(estadoDAO.existsById(estudiante.getEstado().getIdEstado())).thenReturn(true);
        Mockito.when(estudianteDAO.save(Mockito.any())).thenReturn(estudiante);
        Exception exception = assertThrows(Exception.class, ()->{
            estudianteService.crearEstudiante(estudiante);
        });
        assertEquals(exception.getMessage(), CORREO_EXISTE);

    }

    @Test
    @DisplayName("Deberia fallar Por correo existente estudiante")
    void deberiaFallarPorCorreoExistenteEstudiante() throws Exception {
        EstudianteDTO estudianteDTO = new EstudianteTestDataBuilder()
                .conCorreo("angelamaria731@hotmail.com")
                .build();
        Estudiante estudiante = estudianteMapper.toEntity(estudianteDTO);
        ...
        Mockito.when(estudianteDAO.existsById(estudiante.getEstado().getIdEstado())).thenReturn(true);
        Mockito.when(programaDAO.existsById(estudiante.getPrograma().getIdPrograma())).thenReturn(true);
        Mockito.when(profesorDAO.existsByCorreo(estudiante.getCorreo())).thenReturn(false);
        Mockito.when(estudianteDAO.existsByCorreo(estudiante.getCorreo())).thenReturn(true);
        Mockito.when(estadoDAO.existsById(estudiante.getEstado().getIdEstado())).thenReturn(true);
        Mockito.when(estudianteDAO.save(Mockito.any())).thenReturn(estudiante);
        Exception exception = assertThrows(Exception.class, ()->{
            estudianteService.crearEstudiante(estudiante);
